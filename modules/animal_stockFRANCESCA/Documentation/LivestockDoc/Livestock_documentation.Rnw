...
animal_parent_child_mapping=ReadDatatable("animal_parent_child_mapping")

label=nameData("agriculture", "aproduction", data.table(measuredItemCPC=rangeCarcassWeight[,meat_item_cpc]))

rangeCarcassWeight=setnames(rangeCarcassWeight, c("meat_item_cpc", "carcass_weight_min","carcass_weight_max"), c("measuredItemCPC", "min", "max"))

CPC=GetCodeList("agriculture", "aproduction", "measuredItemCPC",unique(animal_parent_child_mapping[,measured_item_child_cpc]) )

CPC=CPC[type=="LSNP", unit:="kg"]
CPC=CPC[type=="PONP", unit:="grams"]

CPC=setnames(CPC, "code", "measuredItemCPC")

CPC=CPC[,.(measuredItemCPC,unit)]

rangeCarcassWeight=merge(rangeCarcassWeight,CPC, by=c("measuredItemCPC"))
rangeCarcassWeight=merge(rangeCarcassWeight,label, by=c("measuredItemCPC"))

rangeCarcassWeight=setnames(rangeCarcassWeight, c("measuredItemCPC_description"), c("label"))

rangeCarcassWeight=setcolorder(rangeCarcassWeight, c("measuredItemCPC","label", "min", "max", "unit"))

rangeCarcassWeight=rangeCarcassWeight[, label:=gsub(", fresh or chilled", "",label)]

print(rangeCarcassWeight)
...
setnames(animalMeatMappingTable, c("measured_item_parent_cpc","measured_item_parent_cpc_description", "measured_item_child_cpc","measured_item_child_cpc_description"), c("ItemParentCode", "ItemParent", "ItemChildCode", "ItemChild") )
         
animalItem=unique(animalMeatMappingTable[,.(ItemParentCode, ItemParent)])
print(animalItem)
...
<<my-label, eval=TRUE, echo=FALSE, dev='png'>>=
print(animalMeatMappingTable[ItemParentCode=="02140", .(ItemParentCode,ItemParent,ItemChildCode, ItemChild)])
print(animalMeatMappingTable[, .(ItemParentCode,ItemParent,ItemChildCode, ItemChild)])
@
...
<<my-label, eval=TRUE, echo=FALSE, dev='png'>>=
element_codes=ReadDatatable("element_codes")
animal_parent_child_mapping=ReadDatatable("animal_parent_child_mapping")


#CPC_amnimal=GetCodeList("agriculture", "aproduction","measuredItemCPC", unique(animal_parent_child_mapping[,measured_item_parent_cpc]) )
CPC_meat= GetCodeList("agriculture", "aproduction","measuredItemCPC",unique(animal_parent_child_mapping[,measured_item_child_cpc]) )   

#CPC=rbind(CPC_meat,CPC_amnimal)

CPC_meat=CPC_meat[,.(code,description, type)]

element_codes[itemtype %in% c("LSPR", "POPR","LSNP","OFF","PONP", "PSKN","POFF","HIDE","DERA"),.(itemtype,description,
                                                                                                 areaharvested,
                                                                                                 yield,
                                                                                                 production,
                                                                                                 factor )]
...
<<my-label, eval=TRUE, echo=FALSE, dev='png'>>=
eggItem=ReadDatatable("animal_eggs_correspondence")
setnames(eggItem, c("animal_item_cpc"), c("measuredItemFbsSua"))
eggItem=nameData("suafbs", "sua_unbalanced", eggItem)
setnames(eggItem, c("measuredItemFbsSua","measuredItemFbsSua_description", "eggs_item_cpc"),c("Animal code","Animal", "measuredItemFbsSua"))

eggItem=nameData("suafbs", "sua_unbalanced", eggItem)
setnames(eggItem, c("measuredItemFbsSua","measuredItemFbsSua_description"),c("Egg code","Egg"))
print(eggItem)
@
...
<<my-label, eval=TRUE, echo=FALSE, dev='png'>>=
milkItem=ReadDatatable("animal_milk_correspondence")
setnames(milkItem, c("animal_item_cpc"), c("measuredItemFbsSua"))
milkItem=nameData("suafbs", "sua_unbalanced", milkItem)
setnames(milkItem, c("measuredItemFbsSua","measuredItemFbsSua_description", "milk_item_cpc"),c("Animal code","Animal", "measuredItemFbsSua"))

milkItem=nameData("suafbs", "sua_unbalanced", milkItem)
setnames(milkItem, c("measuredItemFbsSua","measuredItemFbsSua_description"),c("milk code","milk"))
print(milkItem)
@
