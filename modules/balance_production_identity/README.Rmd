# Balance Production Identity Module
...
To compile this file and generate the `main.R` for the module please run:
...
database) or just local session. If all yields should be updated, extend the key
...
There are different formulas for various commodities, to account for this, we
loop through all the formulas where possible for each commodity.
