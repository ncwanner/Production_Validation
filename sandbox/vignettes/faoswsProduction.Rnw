...
The documentation for the \pkg{faoswsImputation} provides a very clear example
for how this package works.  No further documentation is provided in this
vignette at the moment, but in the future there may be additional functionality
in this package that should be documented in this vignette.
