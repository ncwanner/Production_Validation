...
\author{Joshua M. Browning\\ Food and Agriculture Organization \\ of the United
    Nations}
...
\Abstract{ 
  ...
  methodology paper. Arguments and default setting for each function
  are explained with illustrating examples. The final section is for
  technical readers who are interested in building their ensemble
  model, with information on how to design sensible component models
  and how to build the ensemble.
