...
#     warning("MAJOR HACK!  We're just assigning observations a XX method flag ",
#             "to ensure they get overwritten later.  This should be a 'u' but ",
#             "Salar doesn't want 0Mu imputed.")
