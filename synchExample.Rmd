---
title: "Synchronization of the number of slaughtered animals"
output: pdf_document
...
Below is a reference table containing the commodities and element codes used by this module (as provided by Tomasz, but converted into CPC using the current mapping table).

```{r, echo = FALSE}
dRef = read.csv("/media/hqlprsws1_qa/browningj/production/slaughtered_synchronized.csv",
                colClasses = "character")
colnames(dRef) = c("Parent CPC", "Parent Item", "Parent Element",
                   "Child CPC", "Child Item", "Child Element")
knitr::kable(dRef)
```